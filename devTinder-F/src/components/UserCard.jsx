    ...
    <div className="flex flex-wrap gap-2">
      {(Array.isArray(skills) ? skills : skills.split(",")).map((skill, index) => (
        ...
        <div className="flex justify-between mt-4">
          <button className="bg-red-300 hover:bg-red-400 p-2 rounded-full border-2 border-red-400 shadow-md transition-transform hover:scale-105">
            <ImCross className="h-5 w-5 text-red-700" />
          </button>
          <button className="bg-pink-400 hover:bg-pink-500 p-2 rounded-full border-2 border-pink-500 shadow-md transition-transform hover:scale-105">
